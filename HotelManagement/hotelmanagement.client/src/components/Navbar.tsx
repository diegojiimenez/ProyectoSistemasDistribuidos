...
import { HabitacionesModal } from "./Hotel/HabitacionesModal";
  ...
  return (
    <>
          ...
          <div className="navbar-actions">
            ...
            {location.pathname === "/reservas" && (
              <>
                ...
                <button className="btn-secondary" onClick={() => setIsHabitacionesModalOpen(true)}>
                  Habitaciones
                </button>
              </>
            )}
      ...
      <HabitacionesModal
        ...
        onClose={() => setIsHabitacionesModalOpen(false)}
      />
    </>
  );
};
